...
bool is_sorted(int *a, int n){
    ...
    if(a[0]<=a[1]){/* case B where we divide next all terms leaving the 
    first  one and taking the index as 0 of the 1st element*/
        bool chhota_sorted= is_sorted(a+1,n-1);
